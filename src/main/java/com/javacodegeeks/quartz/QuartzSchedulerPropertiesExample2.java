...
public class QuartzSchedulerPropertiesExample2 implements ILatch {
	private int repeatCount = 3;
	private CountDownLatch latch = new CountDownLatch(repeatCount + 1);

	public static void main(String[] args) throws Exception {
		QuartzSchedulerPropertiesExample2 quartzSchedulerExample = new QuartzSchedulerPropertiesExample2();
